    ...
    EXPORT SNAKELDR_CELL_COLOR
    EXPORT SNAKELDR_WALL_COLOR
    ...
    EXPORT SNAKELDR_LADDER_COLOR
    EXPORT SNAKELDR_SNAKE_COLOR

ONGOING_GAME        EQU     0x0000
PLAYER_ONE          EQU     0x0001
PLAYER_TWO          EQU     0x0002
BOARD_DIM           EQU     0x0140
SNAKELDR_CELL_COLOR          EQU     0x1C16
SNAKELDR_WALL_COLOR          EQU     0xF860
PLAYER_ONE_COLOR    EQU     0x0000
PLAYER_TWO_COLOR    EQU     0x1F02
SNAKELDR_LADDER_COLOR        EQU     0x0E70
SNAKELDR_SNAKE_COLOR         EQU     0xF800

LADDER_ONE_POS      EQU     0x1533
LADDER_TWO_POS      EQU     0x0624
LADDER_THREE_POS    EQU     0x1D45
SNAKE_ONE_POS       EQU     0x3911
SNAKE_TWO_POS       EQU     0x5C2A
SNAKE_THREE_POS     EQU     0x2C18

    ALIGN

    AREA SNAKE_LADDER_DATA, DATA, READWRITE
    EXPORT SNAKELDR_CurrentPlayer
    EXPORT PLAYER_ONE_POS
    EXPORT PLAYER_TWO_POS
    EXPORT SNAKELDR_GAME_STATUS
    EXPORT PLAYER_MOVES

SNAKELDR_CurrentPlayer        DCB   0x0
PLAYER_ONE_POS       DCB   0x0
PLAYER_TWO_POS       DCB   0x0
SNAKELDR_GAME_STATUS          DCB   0x0
PLAYER_MOVES         DCB   0x0
    ...
    EXPORT GET_PLAYER_MOVES
    EXPORT INCREMENT_POSITION
    EXPORT CHECK_LADDER_START
    EXPORT CHECK_SNAKE_START
    EXPORT TOGGLE_PLAYER
    EXPORT SNAKELDR_CHECK_WINNING
    ENTRY
...
TO_END_SNAKE
    POP{R0-R12,PC}
    ENDFUNC
SNAKELDR_CHECK_WINNING      FUNCTION
    PUSH{R0-R12,LR}
...
get_random  FUNCTION
    ...
    ; Load PRNG state
    LDR     R4, =sys_time     ; R4 = address of prng_state
